  ...
  const articles = {
    ...
    article3: {
      ...
      content: `
        ...
        <img src="img/consultas.jpeg" alt="Documentos legales" style="width: 100%; border-radius: 10px; margin-bottom: 20px;">
    ...
    article4: {
      ...
      content: `
        ...
        <img src="img/finanzas.jpeg" alt="Financiamiento" style="width: 100%; border-radius: 10px; margin-bottom: 20px;">
    ...
    article5: {
      ...
      content: `
        ...
        <img src="img/crecimientoneg.jpeg" alt="Crecimiento de Negocios" style="width: 100%; border-radius: 10px; margin-bottom: 20px;">
    ...
    article6: {
      ...
      content: `
        ...
        <img src="img/crecimientoes.jpeg" alt="Crecimiento Económico" style="width: 100%; border-radius: 10px; margin-bottom: 20px;">
    ...
    article7: {
      ...
      content: `
        ...
        <img src="img/desarrollopor.jpeg" alt="Desarrollo Portuario" style="width: 100%; border-radius: 10px; margin-bottom: 20px;">
    ...
    article8: {
      ...
      content: `
        ...
        <img src="img/crecimientoecore.jpeg" alt="Crecimiento Eco-responsable" style="width: 100%; border-radius: 10px; margin-bottom: 20px;">
    ...
    article9: {
      ...
      content: `
        ...
        <img src="img/ubicaciones.jpeg" alt="Mejores Ubicaciones" style="width: 100%; border-radius: 10px; margin-bottom: 20px;">
